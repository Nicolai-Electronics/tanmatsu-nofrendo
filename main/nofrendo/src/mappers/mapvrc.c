...
static void map21_write(uint32_t address, uint8_t value) {
    switch (address) {
        case 0x8000:
            if (select_c000)
...
static map_memwrite map21_memwrite[] = {{0x8000, 0xFFFF, map21_write}, {-1, -1, NULL}};

static map_memwrite map22_memwrite[] = {{0x8000, 0xFFFF, map22_write}, {-1, -1, NULL}};

static map_memwrite map23_memwrite[] = {{0x8000, 0xFFFF, map23_write}, {-1, -1, NULL}};
