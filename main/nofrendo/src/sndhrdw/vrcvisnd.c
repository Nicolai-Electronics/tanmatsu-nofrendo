...
static int32_t vrcvi_rectangle(vrcvirectangle_t* chan) {
    ...
    */
    ...
    if (false == chan->enabled) return 0;
...
static apu_memwrite vrcvi_memwrite[] = {{0x9000, 0x9002, vrcvi_write}, /* vrc6 */
                                        {0xA000, 0xA002, vrcvi_write},
                                        {0xB000, 0xB002, vrcvi_write},
                                        {-1, -1, NULL}};

apuext_t vrcvi_ext = {NULL,                               /* no init */
                      NULL,                               /* no shutdown */
                      vrcvi_reset,   vrcvi_process, NULL, /* no reads */
                      vrcvi_memwrite};
