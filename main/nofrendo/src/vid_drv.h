...
typedef struct viddriver_s {
    ...
    void (*custom_blit)(bitmap_t* primary, int num_dirties, rect_t* dirty_rects);
...
extern void vid_blit(bitmap_t* bitmap, int src_x, int src_y, int dest_x, int dest_y, int blit_width, int blit_height);
